...
def GetSamples(location = 'CERN', year = '2017'):
    ...
    if (location == 'UF'):
        ...
        if (year == 2016):
            in_dir = '/store/group/phys_higgs/HiggsExo/H2Mu/UF/ntuples/Moriond17/Mar13_hiM'
        else:
            print 'Invalid location (%s) and/or year (%d)!!!  Exiting.' % (location, year)
            sys.exit
    ...
    samples.append( SampleInfo('H2Mu_gg_120', 'GluGlu_HToMuMu_M120_13TeV'+sig_gen, 0.009618, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    samples.append( SampleInfo('H2Mu_gg_130', 'GluGlu_HToMuMu_M130_13TeV'+sig_gen, 0.009618, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    ...
    samples.append( SampleInfo('H2Mu_ZH_120', 'ZH_HToMuMu_M120_13TeV_powheg_pythia8', 0.0002136, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    samples.append( SampleInfo('H2Mu_ZH_130', 'ZH_HToMuMu_M130_13TeV_powheg_pythia8', 0.0002136, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    
    samples.append( SampleInfo('H2Mu_WH_pos',     'WPlusH_HToMuMu_M125_13TeV_powheg_pythia8', 0.0001858, year, in_dir, 'Sig') )
    samples.append( SampleInfo('H2Mu_WH_pos_120', 'WPlusH_HToMuMu_M120_13TeV_powheg_pythia8', 0.0001858, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    samples.append( SampleInfo('H2Mu_WH_pos_130', 'WPlusH_HToMuMu_M130_13TeV_powheg_pythia8', 0.0001858, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    
    samples.append( SampleInfo('H2Mu_WH_neg',     'WMinusH_HToMuMu_M125_13TeV_powheg_pythia8', 0.0001164, year, in_dir, 'Sig') )
    samples.append( SampleInfo('H2Mu_WH_neg_120', 'WMinusH_HToMuMu_M120_13TeV_powheg_pythia8', 0.0001164, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    samples.append( SampleInfo('H2Mu_WH_neg_130', 'WMinusH_HToMuMu_M130_13TeV_powheg_pythia8', 0.0001164, year, in_dir, 'Sig') ) ## Presumably incorrect? - AWB 16.09.2018
    ...
    if (year == 2017):
        samples.append( SampleInfo('tt_ll_MG', 'TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8', 85.656, year, in_dir, 'Bkg') ) ## A bit lower than TOP-18-008 (87.315) - AWB 28.09.2018
    if (year == 2017):
    ...
    samples.append( SampleInfo('ZZ_4l_AMC',  ZZ_4l_DAS,                                      1.212, year, in_dir, 'Bkg') )
