...
bool DimuPass   (NTupleBranches & br, MuPairInfo & Dimu, int mass_low = 60, int mass_high = 500, int lead_pt_cut = 30, std::string id = "medium", bool verbose = false);
bool JetPass	(JetInfo & jet  , int pt = 30, std::string PU_ID = "medium", bool verbose = false);
bool BJetPass    (JetInfo & jet  , int pt = 30, std::string PU_ID = "medium", bool verbose = false);
