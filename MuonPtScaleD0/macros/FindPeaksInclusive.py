...
# ttbar samples with d0_BS
INDIR = '/afs/cern.ch/work/e/eyigitba/public/H2Mu/%s/Histograms/MassCal_ptVsd0_d0BS_ttbar/files/HADD' % YEAR
...
OUTDIR = 'plots_ttbar_d0BS_linear_%s' % YEAR
