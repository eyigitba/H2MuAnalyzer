...
OUTDIR = 'plots_2D_PUBinned_final_%s' % YEAR
    ...
    for var in ['dRelPt2p0']:
        for corr in ['Roch']:
            ...
            for eta in ['eta_0_0p9', 'eta_0p9_1p7', 'eta_1p7_inf', 'eta_inc']: # |eta| binned
                ...
                iPt = -1
                for pt in ['nVtx_0_21', 'nVtx_34_inf']:
                    iPt += 1
                    g_str = pt + '_' + c_str
                ...
                leg.AddEntry( fit['nVtx_0_21_'+c_str], 'nVtx < 21 : y = %.2f + %.2f \pm %.2f *d0' % (fit['nVtx_0_21_'+c_str].GetParameter(0), fit['nVtx_0_21_'+c_str].GetParameter(1), fit['nVtx_0_21_'+c_str].GetParError(1)) )
                leg.AddEntry( fit['nVtx_34_inf_'+c_str], 'nVtx > 34 : y = %.2f + %.2f \pm %.2f *d0' % (fit['nVtx_34_inf_'+c_str].GetParameter(0), fit['nVtx_34_inf_'+c_str].GetParameter(1), fit['nVtx_34_inf_'+c_str].GetParError(1)) )
                leg.Draw('same')
                ...
                for i in range(D0_BINS):
                    ...
                    h_1.SetBinContent(i+2, data['nVtx_0_21_'+c_str]['y'][i])
                    h_1.SetBinError(i+2, data['nVtx_0_21_'+c_str]['yerr'][i])
                    h_2.SetBinContent(i+2, data['nVtx_34_inf_'+c_str]['y'][i])
                    h_2.SetBinError(i+2, data['nVtx_34_inf_'+c_str]['yerr'][i])
