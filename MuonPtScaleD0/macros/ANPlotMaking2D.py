...
OUTDIR = 'plots_DY_PV_BS_AN_lowRes_%s' % YEAR
...
def main():
    ...
    # plot_pull = in_file.Get('pull_gen/pull_ZJets_AMC_RochBS').Clone()
    # plot_data = in_file.Get('data_over_MC/Mean_data_over_MC_ZJets_AMC_RochBS').Clone()
    ...
    ccanv.SaveAs('%s/%s_PV.png' % (OUTDIR, OUTDIR))
