...
# Can fit blinded or unblinded histograms. Could be used to fit the signal with a few tweaks.
    ...
    def fit(self, histo, pdfMmumu, x, xmin=110, xmax=200, blinded=False, save=True):
...
#bgsf = BGSpectrumFitter('/afs/cern.ch/user/m/mukim/potatoes/Data/muPairs_mass.root', 'c_01_test')
#h1 = bgsf.bg_all_hist
#x1 = bgsf.getX(h1)
